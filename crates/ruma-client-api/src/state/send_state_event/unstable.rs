...
use ruma_events::{AnyStateEventContent, AnyTimelineEvent, StateEventContent, StateEventType};
...
impl Request {
    ...
    pub fn new<T, K>(room_id: OwnedRoomId, state_key: &K, content: &T) -> serde_json::Result<Self>
    where
        T: StateEventContent,
        T::StateKey: Borrow<K>,
        K: AsRef<str> + ?Sized,
...
impl Response {
    ...
    pub fn new(event_id: OwnedEventId, pdu: Raw<AnyTimelineEvent>) -> Self {
        Self { event_id, pdu }
    }
}
...
impl ruma_common::api::OutgoingRequest for Request {
    ...
    fn try_into_http_request<T: Default + bytes::BufMut>(
        ...
        let query_string = serde_html_form::to_string(RequestQuery { timestamp: self.timestamp })?;
