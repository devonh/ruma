...
use ruma_events::{
    AnyMessageLikeEventContent, AnyTimelineEvent, MessageLikeEventContent, MessageLikeEventType,
};
...
const METADATA: Metadata = metadata! {
    ...
    history: {
        unstable => "/_matrix/client/unstable/org.matrix.msc_cryptoids/rooms/:room_id/send/:event_type/:txn_id",
    }
};
